# ANS WFM 4.4 — Login definitivo + escala dinâmica
...
- Os arquivos JS agora são carregados com um número de versão na URL (`usuarios.js?v=4.4`). Isso força o navegador a tratá-los como um arquivo diferente a cada versão nova, ignorando qualquer cópia antiga guardada — sem precisar de F5 forçado.
